...
var smallIcon = L.icon({
	iconUrl: '/leaflet/images/editmarker.png'
	, iconSize: [11, 11]
	, iconAnchor: [6, 6]
});
var bigIcon = L.icon({
    ...
    _addMethods: function() {
        ...
        this._parseOptions = function(options) {
            ...
            if(!options.pointIcon)
                //this._options.pointIcon = L.icon({ iconUrl: '/leaflet/images/marker-icon.png', iconSize: [25, 41], iconAnchor: [13, 41] });
                //this._options.pointIcon = L.icon({ iconUrl: '/leaflet/images/marker-icon.png', iconSize: [13, 21], iconAnchor: [7, 21] });
            ...
            if(!options.newPointIcon)
                this._options.newPointIcon = L.icon({
									iconUrl: '/leaflet/images/editmarker2.png'
									, iconSize: [0, 0]
									, iconAnchor: [1, 1] 
								});
        };
        ...
        this._showBoundMarkers = function() {
            ...
            for(var polylineNo in that._map._editablePolylines) {
                ...
                for(var markerNo in polyline._markers) {
					...
					var bStr = bounds +"";
                    if(bStr.indexOf(marker.getLatLng()) > -1) 
                        found += 1;
                }
            }
